...
Input: s = "(())))("
Output: 4
Explanation: After index 4, the string splits into "(()))" and "(". The number of opening brackets in the first part is 3 and the number of closing brackets in the second part is also 3.
